window.APP = {
  ...
  mounted() {
    post('http://esxbalkan_chat/loaded', JSON.stringify({}));
  ...
  methods: {
    ...
    send(e) {
      if(this.message !== '') {
        post('http://esxbalkan_chat/chatResult', JSON.stringify({
    ...
    hideInput(canceled = false) {
      if (canceled) {
        post('http://esxbalkan_chat/chatResult', JSON.stringify({ canceled }));
      }
      this.message = '';
