...
CreateThread(function()
    ...
    while GetResourceState('oxmysql') ~= 'started' do
        Wait(1000)
	print('ESX BALKAN MAFIJE ERROR, GRESKA: SKRIPTA oxmysql nije startana na serveru!!! ili ste promjenili ime skripte?')
    end
...
-- Ove tabele vec postoje u db, a ovaj query baca error, tkd najbolje ugasiti.. :|
