...
RegisterKeyMapping('+mehanicare', 'MEHANICAR E', 'keyboard', 'E')
-- Main thread
RegisterCommand('-mehanicare', function()
    ---prazno mora biti
end, false)
RegisterCommand('+mehanicare', function()
...
RegisterKeyMapping('+mehf6', 'MEHANICAR F6', 'keyboard', 'F6')
-- Main thread
RegisterCommand('-mehf6', function()
    ---prazno mora biti
end, false)
RegisterCommand('+mehf6', function()
...
RegisterKeyMapping('+mehNPC', 'MEHANICAR DEL', 'keyboard', 'DELETE')
-- Main thread
RegisterCommand('-mehNPC', function()
    ---prazno mora biti
end, false)
RegisterCommand('+mehNPC', function()
	if not isDead and ESX.PlayerData.job and ESX.PlayerData.job.name == 'mechanic' then
