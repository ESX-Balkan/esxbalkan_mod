		...
		Vehicles = {
			{
				...
				SpawnPoints = {
					{coords = vector3(297.2, -1429.5, 29.8), heading = 54.57, radius = 4.0},
					{coords = vector3(294.0, -1433.1, 29.8), heading = 54.57, radius = 4.0},
					{coords = vector3(309.4, -1442.5, 29.8), heading = 54.57, radius = 6.0}
				}
			}
		},
