...
$(document).on('click','#closebanking',function(){
    $('body').fadeOut(500);
    $.post('http://esxbalkan_banke/NUIFocusOff', JSON.stringify({}));
})

$(document).on('click','#withdraw',function(e){
    e.preventDefault();
    $.post('http://esxbalkan_banke/withdraw', JSON.stringify({
...
$(document).on('click','#depositarpasta',function(e){
    e.preventDefault();
    $.post('http://esxbalkan_banke/deposit', JSON.stringify({
...
$(document).on('click','#transferirpasta',function(e){
    e.preventDefault();
    $.post('http://esxbalkan_banke/transfer', JSON.stringify({
