...
$(".btnQuestion").click(function () {
	$.post('http://esxbalkan_autoskola/question', JSON.stringify({}));
});

$(".btnClose").click(function () {
	$.post('http://esxbalkan_autoskola/close', JSON.stringify({}));
	userAnswer = [];
	goodAnswer = [];
	questionUsed = [];
	questionNumber = 1;
...
$(".btnKick").click(function () {
	$.post('http://esxbalkan_autoskola/kick', JSON.stringify({}));
	userAnswer = [];
	goodAnswer = [];
	questionUsed = [];
	questionNumber = 1;
