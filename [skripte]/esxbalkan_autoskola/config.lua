...
--Koliko ce za sta da kosta
--Dmv teoritski deo,drive auto,drive_bike motor,drive_truck kamion
Config.Prices = {
	dmv         = 500,
	drive       = 2500,
	drive_bike  = 3000,
...
--Modeli za vozila koje ce se dobijaju kad se polaze
...
--Maximumna brzina kojom vozilo sme da se krece
Config.SpeedLimits = {
	residence = 50,
	town      = 80,
	freeway   = 120
...
--Zone za teoritski deo i gde se  spawna vozilo
Config.Zones = {
