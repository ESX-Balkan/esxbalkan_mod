Config = {}
Config.Locale = "en"
Config.IncludeCash = false -- Uključiti novac u inventar?
Config.IncludeWeapons = false -- Uključiti oružje u inventar?
Config.IncludeAccounts = true -- Uključiti račune (banke, black money, ...)?
Config.ExcludeAccountsList = {"bank"} -- Lista imena naloga koje treba isključiti iz inventara
Config.OpenControl = 289 -- Za open inventorya
Config.MaxWeight = 80 --SAME AS THE DEFAULT ON ES EXTENDED CONFIG

Config.Attachments = {"flashlight", "grip", "scope", "skin", "suppressor"}

-- Lista naziva stavki koja ce zatvoriti korisnicki interfejs kada se koristi
Config.CloseUiItems = {
  'bread',
}
--Blipovi
