...
Citizen.CreateThread(function()
    ...
    for k, v in pairs(Config.Shops.RegularShop.Locations) do
        CreateBlip(vector3(Config.Shops.RegularShop.Locations[k].x, Config.Shops.RegularShop.Locations[k].y, Config.Shops.RegularShop.Locations[k].z ), "Prodavnica", 3.0, Config.Color, Config.ShopBlipID)
    end
    ...
    for k, v in pairs(Config.Shops.YouTool.Locations) do
        CreateBlip(vector3(Config.Shops.YouTool.Locations[k].x, Config.Shops.YouTool.Locations[k].y, Config.Shops.YouTool.Locations[k].z ), "Prodavnica Alata", 3.0, Config.Color, Config.YouToolBlipID)
    end

    for k, v in pairs(Config.Shops.WeaponShop.Locations) do
        CreateBlip(vector3(Config.Shops.WeaponShop.Locations[k].x, Config.Shops.WeaponShop.Locations[k].y, Config.Shops.WeaponShop.Locations[k].z), "Oruzarnica", 3.0, Config.WeaponColor, Config.WeaponShopBlipID)
    end
end)
        ...
        if IsPedOnFoot(player) then
            for k, v in pairs(Config.Shops.RegularShop.Locations) do
                ...
                if distance < 10 then
                    ...
                    if distance < 3.0 then 
                        DrawText3Ds(Config.Shops.RegularShop.Locations[k].x, Config.Shops.RegularShop.Locations[k].y, Config.Shops.RegularShop.Locations[k].z + 1, "Stisni [~g~E~w~] da otvoris shop")
                        near = true
                        break
                    end
                    near = true
            ...
            for k, v in pairs(Config.Shops.IlegalShop.Locations) do
                ...
                if distance < 10 then
                    ...
                    if distance < 3.0 then 
                        DrawText3Ds(Config.Shops.IlegalShop.Locations[k].x, Config.Shops.IlegalShop.Locations[k].y, Config.Shops.IlegalShop.Locations[k].z + 1, "Stisni [~g~E~w~] da otvoris shop")
                        near = true
                        break
                    end
                    near = true
            ...
            for k, v in pairs(Config.Shops.RobsLiquor.Locations) do
                ...
                if distance < 10 then
                    ...
                    if distance < 3.0 then 
                        DrawText3Ds(Config.Shops.RobsLiquor.Locations[k].x, Config.Shops.RobsLiquor.Locations[k].y, Config.Shops.RobsLiquor.Locations[k].z + 1, "Stisni [~g~E~w~] da otvoris shop")
                        near = true
                        break
                    end
                    near = true
            ...
            for k, v in pairs(Config.Shops.YouTool.Locations) do
                ...
                if distance < 10 then
                    ...
                    if distance < 3.0 then 
                        DrawText3Ds(Config.Shops.YouTool.Locations[k].x, Config.Shops.YouTool.Locations[k].y, Config.Shops.YouTool.Locations[k].z + 1, "Stisni [~g~E~w~] da otvoris shop")
                        near = true
                        break
                    end
                    near = true
            ...
            for k, v in pairs(Config.Shops.PrisonShop.Locations) do
                ...
                if distance < 10 then
                    ...
                    if distance < 3.0 then 
                        DrawText3Ds(Config.Shops.PrisonShop.Locations[k].x, Config.Shops.PrisonShop.Locations[k].y, Config.Shops.PrisonShop.Locations[k].z + 1, "Stisni [~g~E~w~] da otvoris shop")
                        near = true
                        break
                    end
                    near = true
            ...
            for k, v in pairs(Config.Shops.WeaponShop.Locations) do
                ...
                if distance < 10 then
                    ...
                    if distance < 3.0 then 
                        DrawText3Ds(Config.Shops.WeaponShop.Locations[k].x, Config.Shops.WeaponShop.Locations[k].y, Config.Shops.WeaponShop.Locations[k].z + 1, "Stisni [~g~E~w~] da otvoris shop")
                        near = true
                        break
                    end
                    near = true
            ...
            for k, v in pairs(Config.Shops.PoliceShop.Locations) do
                ...
                if distance < 10 then
                    ...
                    if distance < 3.0 then 
                        DrawText3Ds(Config.Shops.PoliceShop.Locations[k].x, Config.Shops.PoliceShop.Locations[k].y, Config.Shops.PoliceShop.Locations[k].z + 1, "Stisni [~g~E~w~] da otvoris shop")
                        near = true
                        break
                    end
                    near = true
